...
#d1=d1/1.5
#alpha_ip3r=3.5*(0.15/3.2)*(1e7)*(1e6)/500.0  ## /uM/sec
#ca_er_0=2.75*ca_er_0
...
#plt.subplot(4,2,1)
#plt.plot(t,sol_ad[:,-1],'b-',label='Ca2+ with d(IP3)/2',linewidth=2.2)
#plt.plot(t,sol[:,-1],'r-',label='Ca2+ with d(IP3)',linewidth=2.2)
#plt.legend(loc='best')
#plt.ylabel('Concentration ($\mu$M)',size=10)
#
#plt.subplot(4,2,3)
#plt.plot(t,[np.sum(sol_ad[k,35:43]) for k in range(len(t))],'b--',label='aCaM with d(IP3)/2',linewidth=2.2)
#plt.plot(t,[np.sum(sol[k,35:43]) for k in range(len(t))],'r--',label='aCaM with d(IP3)',linewidth=2.2)
#plt.legend(loc='best')
#plt.ylabel('Concentration ($\mu$M)',size=10)
#
#plt.subplot(4,2,2)
#plt.plot(t,sol_ad[:,-5],'b-',label='Spine V with d(ip3)/2',linewidth=2.5)
#plt.plot(t,sol[:,-5],'r-',label='Spine V with d(ip3)/2',linewidth=2.5)
#plt.legend(loc='best')
#plt.ylabel('Voltage (mV)',size=10)
#
#plt.subplot(4,2,4)
#plt.plot(t,nmdar_flux,'g-',linewidth=2.5,label='NMDAR flux')
#plt.plot(t,ip3r_flux,'m-',linewidth=2.5,label='IP3R flux with d(IP3)')
#plt.plot(t,ip3r_flux_ad,'b-',linewidth=2.5,label='IP3R flux with d(IP3)/2')
#plt.legend(loc='best')
#plt.ylabel('Ca influx rate ($\mu$M/s)',size=10)
#
#plt.subplot(4,2,5)
#plt.plot(t,sol_ad[:,-6],'b-',label='w with d(IP3)/2',linewidth=2.6)
#plt.plot(t,sol[:,-6],'r-',label='w with d(IP3)',linewidth=2.6)
#plt.legend(loc='best')
...
#plt.plot(t,sol_ad[:,2],'b-',label='IP3 with d(IP3)/2',linewidth=2.2)
#plt.legend(loc='best')
...
#
#plt.subplot(4,2,7)
#plt.plot(t,open_prob,'m-',linewidth=2.5,label='Open prob with d(IP3)')
#plt.plot(t,open_prob_ad,'b-',linewidth=2.5,label='Open prob with d(IP3)/2')
#plt.legend(loc='best')
